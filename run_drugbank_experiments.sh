...
# 脚本用于依次运行drugbank数据集的不同extractor实验

echo "========================================="
echo "开始运行drugbank数据集的实验"
echo "========================================="
...
echo "----------------------------------------"
python main.py --dataset drugbank --extractor khop-subtree --attn_norm ratio --attn_dropout 0.0 --edge_dropout 0.0 --mi_objective bce
if [ $? -ne 0 ]; then
...
echo "----------------------------------------"
python main.py --dataset drugbank --extractor probability --attn_norm ratio --attn_dropout 0.0 --edge_dropout 0.0 --mi_objective bce
if [ $? -ne 0 ]; then
